...
The configuration file is organized into sections, and each section 
...
The lines will be executed before all the other steps.
...
xxx defines the name of the action and will be displayed during the script execution.
...
A line starting with the `action_` string (followed by the action name) defines an 
action (command line) to be executed.

The action name will be displayed during the script execution.

The lines will be executed after all the other steps.
